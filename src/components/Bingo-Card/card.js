...
reading.theMoon = "When we encounter the Moon in your win, think about a split path that leads off into the distance this a represention our animalistic nature - one is civilized, and the other wild and feral. Everything in this card seems to echo the other, as if to allude to two possibilities. When you walk down the path, you walk the fine line between conscious and unconscious, between the tamed side of civilization of the dog, and the forces of nature represented by the wolf. The towers on the opposing ends represent the forces of good and evil, and their similarity in appearance can allude to the difficulties that we face in distinguishing between them.";
reading.theStar = "The Star card shows importance in your win.  Your hard work is showing its harvest your land which was once dry is now lush. Be aware of your practical abilities and strengths, it is a good time to tend to your chakras. Take a yoga class and remember to meditate.";
reading.theSun = "The Sun card in your victory presents an feeling of optimism and fulfillment. You have overcome and the dawn which follows the darkest of nights is close. The Sun is the source of all the life on our planet, and it represents life energy itself. Your innocence returned from your fortitude represents the happiness that occurs when you are in alignment with your true self and you have absolutely nothing to hide.";
reading.theTower = "The Tower is the power card in you win. In a act of desperationThey you want to escape the turmoil and destruction within. The Tower is a symbol for the ambition that is constructed on faulty premises. You must be able to destroy what you have built in order to clear out the old ways and welcome something new. Its revelations can come in a flash of truth or inspiration.";
...
reading.theWorld = "The World card in the tarot deck has danced its way to your winning row. You find balance and evolution in movement. The fulfillment and unity that you find is not one that is static, but ever-changing, dynamic and eternal. Together, you symbolize the harmony between all of their energies.";

reading.aceOfCups = "In the winning row Ace of Cups card is showing the highest importance. This cup is being offered to you and is overflowing with sparkling water which symbolizes pure and pristine emotion. If you take this offer, drinking from this cup will surely bring you nothing short of emotional as well as spiritual fulfillment. These five streams represent the power of intuition and show the importance of listening to your inner voice. In order to obtain the kind of emotional or spiritual fulfillment that is depicted in the Ace of Cups, the querent will need to follow this inner voice, and remain true to it, regardless of the situation. This will require emotional discipline, but the rewards that this can bring are hinted at within the card itself: overflowing joy and happiness.";
reading.twoOfcups = "The Two of Cups in your winning row is related to negotiation, trade, cosmic energy, protection, proper conduct, and duality. The Two of Cups refers to something quite positive, it is telling you to look closely at relationships, whether romantic, business or otherwise. It suggests a new partnership is in the works, and it will be created with balance, respect, and honor.";
reading.threeOfCups = "When you draw the Three of Cups in this winning row, you will see three women lifting their cups up in the air in a celebration of some sort. Good times are in the air, wreaths are often associated with success and victory, so your happiness is well deserved. There are feelings of beauty, growth, compassion that can be shared between your family and friends.";
reading.fourOfCups = "The Four of Cups displays power in your win. The Four of Cups represents your tendency to take for granted the things that you have, making it hard for you to see what treasures the universe presents you with. You tend to have the answers to our troubles right around you, but you tend to focus too much on what you do not have.";
reading.fiveOfCups = "The Five of Cups carries such a heavy weight in this row. This card signifies loss as well as the painful challenges which stem from that particular loss. You may be in a great deal of despair in this time you must remember the blessing still in your life so you dint find your self to far removed from your home and loved ones.";
reading.sixofCups = "The Six of Cups smiles upon you with your win, it symbolizes the joy of nostalgia and the comfort of home and childhood innocence. Feel confidence that you give a sense of security and comfort.";
reading.sevenOfCups = "Rising to the top of your victory The Seven of Cups symbolizes imagination, choice, wishful thinking, illusion and fantasy. Believe in your dreams, thoughts and imagination. There are numerous fantasies that are appearing from the cups, which are representative of the many visions that you see while dreaming. The Seven of Cups may imply that you have a number of options to choose from.";
reading.eightOfCups = "WIth this win In the Eight of Cups, you are confronted with the moment of transition. You may be tired of the time you have collecting items, and now you are setting out to seeking a higher purpose. It may be a result of a boredom or unhappiness that comes with realizing that whatever you have been looking for in life isn't as pleasurable or as satisfying as you once assumed it would be. You maybe seeking excitement in the unknown or trying out new things that have the potential to help one grow both mentally as well as spiritually. It also shows the willingness to detach oneself from others so that you can work on self-improvement, self-understanding and growth.";
reading.nineOfCups = "The Nine of Cups is strong in this win. In this card you have found true satisfaction. The Nine of Cups symbolizes a representation of fulfillment and success, both spiritually and materially. Feel free to show the expression of success after achieving your innermost desire.";
reading.tenOfCups = "Oh the Ten of Cups is key to you victory. You are currently in a strong and stable relationship, while also blessed with the abundance of a comfortable home and beautiful children. Your future is bright and rest assure your relationship will be quite peaceful. Above in the sky are blessings from heaven and the end of hard times and sorrows, look forward to a new happy life where each and every one of the family will enjoy.";
reading.pageOfCups = "The Page of Cups is the key card in this victory it represents the unexpected inspiration that comes to us from the unconscious, perhaps in ways that you may not truly understand. You will find it difficult to celebrate or understand your somber mood until you can realize the levity of your unconcious mind.";
reading.knightOfCups = "The Knight of Cups is your power card in this winning row you maybe a messenger of a certain sort. Take your steps confidently moving slowly forward which provides an overall impression of peace and calmness. You will be viewed as a symbol of spirituality, light, and purity.";
reading.queenOfCups = "The Queen of Cups rules is key in this row and the emotional realm. This cup is closed, which is why the Queen of Cups symbolizes the thoughts that come with our unconscious mind. Do not be fearful of being alone this will allow you to think. Allow yourself to recognize your thoughts and feelings from a outside perspective.";
reading.kingOfCups = "The King of Cups is a card in the tarot that shows generosity, control, and emotional balance. Be open to creativity and spirit, which thrives on the calmness you cultivate. There will be a steady balance between the conscious and unconscious as a result.";
...
reading.pageOfPentacles = "The Page of Pentacles finds its way to the top in your win. The card shows your fortune is being held closely, and all that it represents: ambition, security, wealth, nature, and sensuality. The Page of Pentacles symbolizes a person that and shows you are grounded, loyal and diligent.";
